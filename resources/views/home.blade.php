                ...
                <div class="row bg-light">
                    <div class="col-md-4">
                        <div class="profile-img">
                            @if (isset($image))
                            <img class="pimage" src="storage/{{$image}}" alt="no image" />
                            @else
                            <img style="width:270px; height:270px" src={{asset('mp/anon.png')}} alt=""/>
                            @endif
                    ...
                    <div class="col-md-6">
                        <div class="profile-head">
                                    ...
                                    <p class="proile-rating">(( case / recovered / dieth )) : <span>{{ $current }}</span></p>
