...
<head>
    ...
    <title>{{ config('app.name', 'covida') }}</title>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav m-auto">
                        @if (Auth::check())  
                        <li class="list-group"><a class="navbar-brand select text-secondary" href="{{route('mydoctor')}}">My doctor</a></li>
                        <li class="list-group"><a class="navbar-brand select text-secondary" href="{{route('mysymp')}}">My symptoms schedule</a></li>
                        <li class="list-group"><a class="navbar-brand select text-secondary" href="{{route('myreport')}}">My reports</a></li>
