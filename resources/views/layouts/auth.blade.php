            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
                        ...
                        <img width="60" height="60" class="border mr-1 ml-1" style="border-radius:50%" src="{{asset( Auth::user()->image!==''? "storage/".Auth::user()->image."":'mp/anon.png')}}"  alt="no image">
                        <a class="navbar-brand select" href="{{ url('doc/showuser') }}">
                            My Patients
                        </a>
                                             <br>
                        <a class="navbar-brand select" href="{{ url('/doc/editdata') }}">
                            edit profile
                        </a>
                    </ul>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @guest
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('doc.login') }}">{{ __('Login') }}</a>
                            </li>
